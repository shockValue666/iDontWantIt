...
import { Box,Grid,ThemeProvider,Typography,Button } from '@mui/material'
  ...
  return (
    <ThemeProvider theme={theme}>
        <Grid container spacing={5}  height="85vh" width="70vw">
            ...
            <Grid sx={{border:"2px solid black",display:{xs:"none",sm:"block",backgroundImage:"url(https://somespace.fra1.digitaloceanspaces.com/Laboratorium%20%281%292.jpeg)",backgroundSize:"cover"}}}  item xs={0} sm={4}>
                    mikri
            </Grid> 
        </Grid>
    </ThemeProvider>
